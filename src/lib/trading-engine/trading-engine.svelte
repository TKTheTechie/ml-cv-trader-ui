<script lang="ts">
  ...
  import { MarketDataEvent, tickStore, signalStore, gameOver, Signal, portfolioStore } from '../store/store';
...
<section>
  <Chart {data} type="line" bind:this={solaceChart} class="w-full h-full" {lineOptions} {axisOptions} />
</section>
