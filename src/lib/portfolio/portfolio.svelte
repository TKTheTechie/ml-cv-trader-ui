<script lang="ts">
	import { Portfolio, portfolioStore } from '$lib/store/store';
...
<section>
	<div class="w-full justify-center items-center text-center rounded-md border-2 border-green-300">
		<h1
			class="m-2 text-xl font-bold tracking-tighter text-center text-white lg:text-left lg:text-xl title-font"
		>
			Your Portfolio
		</h1>
