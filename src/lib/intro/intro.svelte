	...
	function submitInitials() {
		if (initials.length > 0 && initials.length < 3) {
			...
			solaceClient.publishToTopic(
				'tkthetechie/new/trading/session',
				'{"initials":"' + initials + '"}',
...
<section>
	<div class="flex flex-col w-full items-center">
		<h1
			class="justify-center mb-1 text-xl font-bold tracking-tighter text-center text-white lg:text-center lg:text-xl title-font w-max"
		>
			cv-ml-trader
		</h1>
	</div>
	<div class="text-xl tracking-tighter text-white intro-text">
		...
		<br />
		<br />
		There are three gestures that can be detected - try them now (use your right hand and away from your
		face as shown in the images):

		<div class="grid grid-cols-3  mt-5">
			<div class="items-center">
				<center><img height="90px" width="126px" alt="BUY" src="../../../static/buy.png" /></center>
			</div>
			<div>
				<center
					><img height="90px" width="126px" alt="SELL" src="../../../static/sell.png" /></center
				>
			</div>
			<div>
				<center
					><img height="90px" width="126px" alt="HOLD" src="../../../static/hold.png" /></center
				>
			</div>
