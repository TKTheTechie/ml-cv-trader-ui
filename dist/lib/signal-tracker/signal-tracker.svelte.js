...
function create_fragment(ctx) {
	...
	let t5_value = (/*$connectedToSolace*/ ctx[4]
	? 'CONNECTED TO'
	: 'DISCONNCECTED FROM') + "";
	...
	return {
		c() {
			...
			set_style(video_1, "width", /*videoDimension*/ ctx[5] + "px");
			set_style(video_1, "height", /*videoDimension*/ ctx[5] + "px");
			attr(video_1, "width", video_1_width_value = "" + (/*videoDimension*/ ctx[5] + "px"));
			attr(video_1, "height", video_1_height_value = "" + (/*videoDimension*/ ctx[5] + "px"));
			attr(span, "class", span_class_value = "signal signal-" + /*$signalStore*/ ctx[3] + " text-4xl" + " svelte-172xgqn");
			attr(img, "class", "mt-0.5");

			if (!src_url_equal(img.src, img_src_value = "" + ((/*$connectedToSolace*/ ctx[4]
			? 'connected'
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*$signalStore*/ 8) set_data(t2, /*$signalStore*/ ctx[3]);

			if (!current || dirty & /*$signalStore*/ 8 && span_class_value !== (span_class_value = "signal signal-" + /*$signalStore*/ ctx[3] + " text-4xl" + " svelte-172xgqn")) {
				attr(span, "class", span_class_value);
			}

			if (!current || dirty & /*$connectedToSolace*/ 16 && !src_url_equal(img.src, img_src_value = "" + ((/*$connectedToSolace*/ ctx[4]
			? 'connected'
			: 'disconnected') + ".png"))) {
				attr(img, "src", img_src_value);
			}

			if ((!current || dirty & /*$connectedToSolace*/ 16) && t5_value !== (t5_value = (/*$connectedToSolace*/ ctx[4]
			? 'CONNECTED TO'
...
function instance($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, signalStore, $$value => $$invalidate(3, $signalStore = $$value));
	component_subscribe($$self, connectedToSolace, $$value => $$invalidate(4, $connectedToSolace = $$value));
