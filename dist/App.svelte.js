...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ('beginTrading' in $$props) $$invalidate(0, beginTrading = $$props.beginTrading);
	};

	return [beginTrading, $gameOver];
}

class App extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { beginTrading: 0 });
	}
}
